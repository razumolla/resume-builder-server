...
async function run() {
  try {
    ...
    const serviceCollection = client
      .db("resume_builder")
      .collection("services");
    const cvResumeBlogCollection = client
      .db("carrier_blogs")
      .collection("cvResumeBlog");
    const coverLetterBlogCollection = client
      .db("carrier_blogs")
      .collection("coverLetterBlog");
    const personalDevBlogCollection = client
      .db("carrier_blogs")
      .collection("personalDevBlog");
    const inspiringBlogCollection = client
      .db("carrier_blogs")
      .collection("inspiringBlog");
    //Cover Letter Database Start
    const coverLetterCollection = client
      .db("resume_builder")
      .collection("coverLetter");
    const clPhotoCollection = client
      .db("resume_builder")
      .collection("coverLetterTemplate");
